...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAllUncauException(
        Exception exception, 
        WebRequest request){
        final String erroRMessage = "Unknown error occcured";
    ...
    private ResponseEntity<Object> handleObjectNotFoundException(
        ObjectNotFoundException objectNofFoundException,
        WebRequest request){
        log.error("Failed to find the requested element", objectNofFoundException);
        return buildErrorResponse(objectNofFoundException,HttpStatus.NOT_FOUND, request);
    }
    ...
    public ResponseEntity<Object> handleDataBidingViolationException(
        ...
        return buildErrorResponse(dataBidingViolationException, HttpStatus.CONFLICT, request);    
    }
